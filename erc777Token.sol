...
contract MyERC777 is ERC1820Client, owned {
    ...
    constructor(string memory _name, string memory _symbol, uint256 _granularity, address[] memory _defaultOperators) public {
        mName = _name;
        mSymbol = _symbol;
        mTotalSupply = 0;
    ...
    /// @notice Helper function actually performing the minting of tokens.
    /// @param _tokenHolder The address that will hold the tokens being minted
